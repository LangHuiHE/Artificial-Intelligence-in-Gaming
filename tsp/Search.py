...
def swipeMethod(result, cities, seconds):
    # print(f'after swipeMethod cites size : {len(cities)}')
...
def Search():
    ...
    # print(f'after read file cites size : {len(cities)}')
